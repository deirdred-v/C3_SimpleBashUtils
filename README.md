...
- Use standard and non-standard C libraries, or you can use your own developed libraries from other projects
...
Bonus assignment for extra points. Develop the grep utility:
